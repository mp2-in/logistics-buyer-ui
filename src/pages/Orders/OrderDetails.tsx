...
export default ({ orderInfo, onCancelOrder, onIssueReport, onOrderFulfillment, onAddOrder, actionAtTop, markOrderAsUnfulfilled, role }: {
    ...
    return <>
        ...
        <div className="md:flex items-center">
            ...
            {orderInfo?.pickupProof?<a href={orderInfo.pickupProof} className='text-blue-600 underline font-medium ml-5' target='_blank'>Pickup Proof</a>:<p>Pickup Proof</p>}
        </div>
        ...
        {orderInfo?.deliveryProof?<a href={orderInfo.deliveryProof} className='text-blue-600 underline font-medium ml-5' target='_blank'>Delivery Proof</a>:<p>Delivery Proof</p>}
